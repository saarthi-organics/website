  ...
  const cases = [
    {
      ...
      solution: "Saarthi Organics established an annual procurement contract dedicating 5 tankers from our in-house fleet exclusively to this client. We coordinated supply from sugar refineries to secure batches meeting their specific TRS requirements of above 46.5%.",
  ...
  return (
    <main style={{ marginTop: '72px' }}>
      ...
      <div className="subpage-hero">
        <Image src="/hero_case_studies.png" alt="" fill priority className="subpage-hero-bg" style={{ objectFit: 'cover' }} />
