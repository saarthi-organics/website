  ...
  const cases = [
    {
      ...
      solution: "Saarthi Organics established an annual procurement contract dedicating 5 tankers from our in-house fleet exclusively to this client. We coordinated direct mill allocations to secure batches meeting their specific TRS requirements of above 46.5%.",
