      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Excise-aligned bulk tanker distribution across Haryana, Punjab, Rajasthan, Delhi NCR, Uttarakhand, Gujarat, Madhya Pradesh, and other industrial markets. We supply typical 82%–88% Brix molasses for distilleries, feed mills, yeast plants, and metal castings.
          </p>
