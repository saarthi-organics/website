  ...
  const regionalFaqs = [
    {
      ...
      a: "Our core administrative sourcing desk is based directly in Karnal, Haryana. We maintain standing allocations with sugar mills across Yamunanagar, Panipat, Shahabad, and Sonipat. Once transit passes are generated by the Haryana Excise department, tankers are loaded and dispatched directly from the mill sites to your industrial plant."
    },
    {
      q: "What is the typical Brix and sugar specification of Haryana sugarcane molasses?",
      a: "Haryana molasses typically registers a Brix density between 82% and 88%. The Total Reducing Sugars (TRS) typically range from 45% to 50%, making it an excellent fermentable feedstock. Typical specification sheets or batch-wise reports can be discussed and shared upon request to support processing stability."
    },
    {
