...
export const metadata: Metadata = {
  ...
  description: 'Technical B2B publications, excise compliance updates, and logistics engineering insights on industrial sugarcane molasses sourcing and regional distribution.',
  alternates: {
