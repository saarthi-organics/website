...
export const articles: Article[] = [
  {
    ...
    content: [
      ...
      "Furthermore, every bulk transport movement exceeding Rs. 50,000 requires a registered e-Way Bill specifying the transport vehicle registration number, cargo weight, and dispatch mill coordinates. At Saarthi Organics, we manage all compliance steps. E-Way bills, excise permits, weighment slips, and GST billing are generated instantly upon vehicle dispatch from our partner sugar mills, and our accounting desk ensures that GSTR filings are logged on-time, enabling seamless credit claims for your plant."
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: [
      ...
      "Saarthi Organics mitigates these variations by maintaining direct relationships with modern sugar mill refineries. We coordinate directly with cooperative and private sugar mills to align shipments with standard specification guidelines."
    ]
  },
  {
    id: 11,
